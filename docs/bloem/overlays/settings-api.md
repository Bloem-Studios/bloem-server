# Bloem overlay: Canonical Settings API

Bloem additions and overrides for the upstream Silo document [`docs/settings-api.md`](../../settings-api.md).
...
**Location:** section “Canonical Settings API”, after the paragraph beginning “The canonical settings API stores typed user preferences from the…”. **Bloem adds:**
