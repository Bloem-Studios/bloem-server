...
func TestDirectProfileAllowedRoutesAreThisExactSet(t *testing.T) {
	...
	want := []string{
		...
		"DELETE /api/v1/collections/groups/{id}",
		...
		"GET /api/v1/collections/import/mdblist/search",
		"GET /api/v1/collections/import/mdblist/top",
		"GET /api/v1/collections/server",
		"GET /api/v1/collections/templates",
		...
		"GET /api/v1/library/{id}/user-collections",
		...
		"HEAD /api/v1/stream/{session_id}",
		"HEAD /api/v1/stream/{session_id}/subtitles/{track}",
		...
		"POST /api/v1/collections/groups",
		"POST /api/v1/collections/import/mdblist",
		"POST /api/v1/collections/import/tmdb",
		"POST /api/v1/collections/import/trakt",
		...
		"PUT /api/v1/collections/groups/order",
		"PUT /api/v1/collections/groups/{id}",
		"PUT /api/v1/collections/order",
		"PUT /api/v1/collections/{id}",
		"PUT /api/v1/collections/{id}/items/order",
		"PUT /api/v1/collections/{id}/items/{item_id}",
