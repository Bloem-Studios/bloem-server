...
var lifecycleRouteContracts = []RouteContract{
	...
	lifecycle("organization.create", http.MethodPost, NativeAPIPrefix+"/admin/platform/organizations/", lifecycleidempotency.TargetBodyAccount, false),
	lifecycle("organization.update", http.MethodPatch, NativeAPIPrefix+"/admin/platform/organizations/{id}", lifecycleidempotency.TargetExactMembership, false),
	lifecycle("organization.suspend", http.MethodPost, NativeAPIPrefix+"/admin/platform/organizations/{id}/suspend", lifecycleidempotency.TargetExactMembership, false),
	lifecycle("organization.reactivate", http.MethodPost, NativeAPIPrefix+"/admin/platform/organizations/{id}/reactivate", lifecycleidempotency.TargetExactMembership, false),
	lifecycle("organization.transfer", http.MethodPost, NativeAPIPrefix+"/admin/platform/organizations/{id}/transfer-ownership", lifecycleidempotency.TargetBodyAccount, false),
	lifecycle("organization.membership.create", http.MethodPost, NativeAPIPrefix+"/admin/platform/organizations/{id}/memberships", lifecycleidempotency.TargetBodyAccount, false),
	lifecycle("organization.membership.update", http.MethodPatch, NativeAPIPrefix+"/admin/platform/organizations/{id}/memberships/{membership_id}", lifecycleidempotency.TargetExactMembership, false),
	lifecycle("people.membership.update", http.MethodPatch, NativeAPIPrefix+"/admin/organization/people/{account_id}/memberships/current", lifecycleidempotency.TargetExactMembership, false),
	lifecycle("people.profile.update", http.MethodPatch, NativeAPIPrefix+"/admin/organization/people/{account_id}/profiles/{profile_id}", lifecycleidempotency.TargetPathAccount, false),
	lifecycle("people.policy_job.create", http.MethodPost, NativeAPIPrefix+"/admin/organization/people/policy-jobs", lifecycleidempotency.TargetStoredSelection, false),
	lifecycle("people.bulk_job.create", http.MethodPost, NativeAPIPrefix+"/admin/organization/people/bulk-jobs", lifecycleidempotency.TargetStoredSelection, false),
	lifecycle("entitlement.organization.apply", http.MethodPost, NativeAPIPrefix+"/admin/platform/organizations/{id}/entitlement/apply", lifecycleidempotency.TargetExactMembership, false),
	lifecycle("entitlement.account.apply", http.MethodPost, NativeAPIPrefix+"/admin/platform/accounts/{account_id}/entitlement/apply", lifecycleidempotency.TargetPathAccount, false),
	lifecycle("entitlement.account.apply_legacy", http.MethodPost, NativeAPIPrefix+"/admin/platform/users/{user_id}/entitlement/apply", lifecycleidempotency.TargetPathAccount, false),
	lifecycle("entitlement.organization.policy_job.create", http.MethodPost, NativeAPIPrefix+"/admin/platform/organizations/{organization_id}/entitlement-bulk/policy-jobs", lifecycleidempotency.TargetStoredSelection, false),
	lifecycle("entitlement.direct.policy_job.create", http.MethodPost, NativeAPIPrefix+"/admin/platform/accounts/entitlement-bulk/policy-jobs", lifecycleidempotency.TargetStoredSelection, false),
}
...
var lifecycleNonMutationRoutes = []ReviewedNonMutationRoute{
	{http.MethodPost, NativeAPIPrefix + "/admin/platform/accounts/{account_id}/entitlement/dry-run", "entitlement preview"},
	{http.MethodPost, NativeAPIPrefix + "/admin/platform/users/{user_id}/entitlement/dry-run", "legacy entitlement preview"},
	{http.MethodPost, NativeAPIPrefix + "/admin/platform/organizations/{id}/entitlement/dry-run", "organization entitlement preview"},
	{http.MethodPost, NativeAPIPrefix + "/admin/platform/accounts/{account_id}/entitlement", "method rejected by exact route dispatch"},
	{http.MethodPut, NativeAPIPrefix + "/admin/platform/accounts/{account_id}/entitlement", "method rejected by exact route dispatch"},
	{http.MethodPatch, NativeAPIPrefix + "/admin/platform/accounts/{account_id}/entitlement", "method rejected by exact route dispatch"},
	{http.MethodDelete, NativeAPIPrefix + "/admin/platform/accounts/{account_id}/entitlement", "method rejected by exact route dispatch"},
	{http.MethodPost, NativeAPIPrefix + "/admin/platform/organizations/{organization_id}/accounts/{account_id}/entitlement", "method rejected by exact route dispatch"},
	{http.MethodPut, NativeAPIPrefix + "/admin/platform/organizations/{organization_id}/accounts/{account_id}/entitlement", "method rejected by exact route dispatch"},
	{http.MethodPatch, NativeAPIPrefix + "/admin/platform/organizations/{organization_id}/accounts/{account_id}/entitlement", "method rejected by exact route dispatch"},
	{http.MethodDelete, NativeAPIPrefix + "/admin/platform/organizations/{organization_id}/accounts/{account_id}/entitlement", "method rejected by exact route dispatch"},
}
