...
func registerCatalogItems(reg *Registry) {
	...
	Register(reg, viewer(query), reg.queryCatalogItems)
...
func (reg *Registry) itemViewer(ctx context.Context, imageSize string, libraryID, fileID ID) (handlers.ItemViewer, *Problem) {
	...
	filter, err := reg.deps.CatalogAccess.AccessFilterFor(ctx, opts)
	if err != nil {
...
func catalogItemDetailOf(d *catalogpkg.ItemDetail) CatalogItemDetail {
	...
	return CatalogItemDetail{
		...
		EffectiveSubtitleTrackSignature: d.EffectiveSubtitleTrackSignature, EffectiveVersionResolution: d.EffectiveVersionResolution,
