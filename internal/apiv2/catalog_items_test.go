...
func (f *fakeCatalog) AccessFilterFor(_ context.Context, opts handlers.AccessFilterOptions) (catalogpkg.AccessFilter, error) {
	return catalogpkg.AccessFilter{AllowedLibraryIDs: []int{1, 2}, PresentationLibraryID: opts.PresentationLibraryID, SelectedFileID: opts.SelectedFileID}, nil
}
