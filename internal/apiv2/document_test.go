...
func TestGeneratedDocumentStatuses(t *testing.T) {
	...
	for _, id := range []string{"cancelSubtitleAIJob", "listAdminSubtitleProviders", "listAdminStoredSubtitles", "testAdminSubtitleProvider"} {
		profileToken[id] = true
	}
	...
	for _, id := range []string{"listWatchTogetherSuggestions", "voteWatchTogetherSuggestion", "unvoteWatchTogetherSuggestion", "deleteWatchTogetherSuggestion"} {
		profileToken[id] = true
	}
