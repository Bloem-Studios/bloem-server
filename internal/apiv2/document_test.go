...
func TestGeneratedDocumentStatuses(t *testing.T) {
	...
	for _, id := range []string{"unlinkNotificationDiscord", "getPushRegistrationCapabilities", "registerPushDevice", "unregisterPushDevice", "subscribeNotificationWebPush", "unsubscribeNotificationWebPush", "deleteNotificationWebPushSubscription", "listWatchTogetherSuggestions", "voteWatchTogetherSuggestion", "unvoteWatchTogetherSuggestion", "deleteWatchTogetherSuggestion"} {
		profileToken[id] = true
	}
