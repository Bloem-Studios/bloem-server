...
func TestGeneratedDocumentStatuses(t *testing.T) {
	...
	for _, id := range []string{"getFileMarkers", "getItemMarkers", "setFileMarkers", "setItemMarkers", "clearFileMarkerSegment", "getSubtitleProviderStatus", "getSubtitleAIStatus", "listStoredSubtitles", "searchSubtitles"} {
		profileToken[id] = true
	}
	...
	for _, id := range []string{"getAdminJellyfinCompatStatus", "getAdminSetting", "getAdminSectionSettings", "getAdminPlaybackRoutingCapabilities", "updateAdminRateLimitConfig", "getAdminRateLimitConfig", "getAdminRateLimitStatus", "sendAdminTestEmail", "getAdminServerStatus", "listAdminNodes", "getAdminDashboardTimeseries", "getAdminDashboardPlaybackActivity", "getAdminDashboardTopActivity", "getAdminDashboardDownloadsStats", "deleteAdminDiagnosticReport", "listAdminDiagnosticReports", "getAdminDiagnosticReport", "downloadAdminDiagnosticReport", "getAdminBuildInfo", "getAdminSystemResources", "getAdminStoredSettings", "getAdminEffectiveSettings", "getAdminRestartKeys", "getAdminSensitiveSettingsStatus", "checkAdminSettingsConnection", "getAdminPluginCatalogSettings", "getAdminPluginCatalogStatus", "updateAdminPluginCatalogSettings"} {
		profileToken[id] = true
	}
	...
	for _, id := range []string{"listAdminSubtitleProviders", "testAdminSubtitleProvider"} {
		profileToken[id] = true
	}
