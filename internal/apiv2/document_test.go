...
func TestGeneratedDocumentStatuses(t *testing.T) {
	...
	for _, id := range []string{"downloadAdminStoredSubtitle", "getAdminSubtitleMetadata", "updateAdminSubtitleMetadata", "cancelSubtitleAIJob", "createSubtitleAIJob", "listAdminSubtitleProviders", "listAdminStoredSubtitles", "testAdminSubtitleProvider"} {
		profileToken[id] = true
	}
