...
func TestGeneratedDocumentStatuses(t *testing.T) {
	...
	for _, id := range []string{"getAdminBuildInfo", "getAdminSystemResources", "getAdminStoredSettings", "getAdminEffectiveSettings", "getAdminRestartKeys", "getAdminSensitiveSettingsStatus", "checkAdminSettingsConnection", "getAdminPluginCatalogSettings", "getAdminPluginCatalogStatus", "updateAdminPluginCatalogSettings"} {
		profileToken[id] = true
	}
