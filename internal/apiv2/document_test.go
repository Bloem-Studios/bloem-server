...
func TestGeneratedDocumentStatuses(t *testing.T) {
	...
	for _, id := range []string{"deleteAdminStoredSubtitle", "downloadAdminStoredSubtitle", "getAdminSubtitleMetadata", "updateAdminSubtitleMetadata", "cancelSubtitleAIJob", "createSubtitleAIJob", "listAdminSubtitleProviders", "listAdminStoredSubtitles", "testAdminSubtitleProvider"} {
		profileToken[id] = true
	}
	...
	for _, id := range []string{"deleteAdminNotificationServerChannel", "deleteNotificationWebhook", "clearNotificationEmailAddress", "unlinkNotificationDiscord", "getPushRegistrationCapabilities", "registerPushDevice", "unregisterPushDevice", "subscribeNotificationWebPush", "unsubscribeNotificationWebPush", "deleteNotificationWebPushSubscription", "listWatchTogetherSuggestions", "voteWatchTogetherSuggestion", "unvoteWatchTogetherSuggestion", "deleteWatchTogetherSuggestion"} {
		profileToken[id] = true
	}
