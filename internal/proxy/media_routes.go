...
var proxyMediaRoutes = []streamtelemetry.MediaRoute{
	...
	grantRoute(http.MethodGet, "/stream/v3/{session_id}/subtitles/{track}", streamtelemetry.ClassPlayback, true),
	grantRoute(http.MethodHead, "/stream/v3/{session_id}/subtitles/{track}", streamtelemetry.ClassPlayback, true),
	grantRoute(http.MethodGet, "/stream/v3/{session_id}/subtitles/{track}/fonts", streamtelemetry.ClassPlayback, true),
	proxyRoute(http.MethodHead, "/stream/subtitles/{token}/{track}", streamtelemetry.ClassPlayback, true),
